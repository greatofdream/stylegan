...
if __name__ == '__main__':
    ...
    jt.save_image(img, args.opt_dir+'/sample.png', nrow=args.n_col, normalize=True, range=(-1, 1))
    
    for j in range(20):
        img = style_mixing(generator, step, mean_style, args.n_col, args.n_row)
        jt.save_image(
            img, args.opt_dir+f'/sample_mixing_{j}.png', nrow=args.n_col + 1, normalize=True, range=(-1, 1)
        )